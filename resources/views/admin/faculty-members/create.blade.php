...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Faculty Member</h2>

        <p class="admin-page-subtitle">
            Add a subject teacher or academic mentor card
        </p>
    </div>
</div>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="checkbox-grid">
                    <label class="role-checkbox-item {{ old('is_active', false) ? 'checked' : '' }}">
                        <input type="checkbox"
                               name="is_active"
                               value="1"
                               class="role-checkbox"
                ...
                <div class="form-info-box">
                    <p>
                        <i class="fas fa-info-circle"></i>
                        Faculty image will be uploaded through media library.
                    </p>
                </div>
