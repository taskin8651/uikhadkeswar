...
@section('page-title', 'Edit Founder Responsibility')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">
            Edit Founder Responsibility
        </h2>

        <p class="admin-page-subtitle">
            Update responsibility card title, description, order and visibility
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.founder-responsibilities.update', $founderResponsibility->id) }}">
    @csrf
    @method('PUT')
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="title"
                               id="title"
                               value="{{ old('title', $founderResponsibility->title) }}"
                               required
                ...
                <div class="field-group">
                    ...
                    <textarea name="description"
                              ...
                              class="field-input {{ $errors->has('description') ? 'error' : '' }}">{{ old('description', $founderResponsibility->description) }}</textarea>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="number"
                               name="sort_order"
                               id="sort_order"
                               value="{{ old('sort_order', $founderResponsibility->sort_order) }}"
                               min="0"
                               placeholder="1"
                ...
                <div class="checkbox-grid">
                    <label class="role-checkbox-item {{ old('status', $founderResponsibility->status) ? 'checked' : '' }}">
                        <input type="checkbox"
                               name="status"
                               value="1"
                               class="role-checkbox"
                               {{ old('status', $founderResponsibility->status) ? 'checked' : '' }}>
