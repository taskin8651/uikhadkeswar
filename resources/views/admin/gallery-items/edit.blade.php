...
@php
    $selectedCategories = old(
        'category_slugs',
        isset($galleryItem) && $galleryItem->category_slugs
            ? explode(' ', (string) $galleryItem->category_slugs)
            : []
    );
@endphp
...
<div class="admin-page-head">
    <div>
        ...
        <p class="admin-page-subtitle">
            Update photo, MP4 video or YouTube gallery item
        </p>
    </div>
</div>

<form method="POST"
      action="{{ route('admin.gallery-items.update', $galleryItem->id) }}"
    ...
    <div class="admin-form-grid">
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="label"
                               id="label"
                               value="{{ old('label', $galleryItem->label) }}"
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="media_type"
                            ...
                            @foreach(['image' => 'Image', 'video' => 'MP4 Video', 'youtube' => 'YouTube'] as $value => $label)
                                <option value="{{ $value }}"
                                    {{ old('media_type', $galleryItem->media_type) === $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="field-group">
                    ...
                    @else
                        <p class="field-hint">
                            ...
                            Upload a new image or MP4 only if you want to replace the existing file.
                        </p>
                    @endif
                </div>
                ...
                <div class="field-group">
                    ...
                    @if($galleryItem->thumbnailSource())
                        <div style="margin-top:14px;">
                            <img src="{{ $galleryItem->thumbnailSource() }}"
                                 alt="{{ $galleryItem->alt_text ?: $galleryItem->title }}"
                                 style="width:180px;height:130px;object-fit:cover;border-radius:16px;border:1px solid #e5e7eb;">
                        </div>
                    @endif
                </div>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="source_url"
                               id="source_url"
                               value="{{ old('source_url', $galleryItem->source_url) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="thumbnail_url"
                               id="thumbnail_url"
                               value="{{ old('thumbnail_url', $galleryItem->thumbnail_url) }}"
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="layout"
                            ...
                            @foreach(['normal' => 'Normal', 'tall' => 'Tall', 'wide' => 'Wide'] as $value => $label)
                                <option value="{{ $value }}"
                                    {{ old('layout', $galleryItem->layout) === $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="checkbox-grid">
                    <label class="role-checkbox-item {{ old('status', $galleryItem->status) ? 'checked' : '' }}">
                        <input type="checkbox"
                               name="status"
                               value="1"
                               class="role-checkbox"
                               {{ old('status', $galleryItem->status) ? 'checked' : '' }}>
